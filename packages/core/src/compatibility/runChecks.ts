...
import { createCheckReport, createCompatibilityResult } from "./checkReport.js";
import type { CheckReport, CompatibilityResult } from "./checkReport.js";

export function runChecks(resolvedProject: ResolvedProject): CheckReport {
  return createCheckReport({
    compatibility: [
      ...checkConnectorLengths(resolvedProject),
      ...checkRequirements(resolvedProject)
    ]
  });
}
